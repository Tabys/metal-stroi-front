	...
	return (
		<tr>
			...
			{total.choping > 0 ? (
				<td>
					{detail.choping
						? (Number(detail.choping) / detail.quantity).toFixed(2)
						: '0'}
				</td>
			) : (
				''
			...
			{Number(total.painting) > 0 ? (
				<td>
					{(Number(detail.painting) / detail.quantity).toFixed(2)}
				</td>
			) : (
				''
			)}
			{total.rolling > 0 ? (
				<td>{(Number(detail.rolling) / detail.quantity).toFixed(2)}</td>
			) : (
				''
			)}
			{total.drowing > 0 ? (
				<td>{(Number(detail.drowing) / detail.quantity).toFixed(2)}</td>
			) : (
				''
			)}
